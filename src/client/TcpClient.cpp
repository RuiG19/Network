...
TcpClient::TcpClient(std::string ip_, uint16_t port_, std::string server_ip_, uint16_t server_port_, std::function<void(std::unique_ptr<Payload> rxBuffer_)> handler_)
    : Client<Tcp>(ip_, port_, server_ip_, server_port_, handler_)
{

}

void TcpClient::start_up()
{
    try
    {
